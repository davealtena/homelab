---
name: add-app
description: Scaffold a new Flux application in this home-ops repo's conventions (ks.yaml + app/{ocirepository,helmrelease,kustomization}, optional externalsecret). Use when adding a new app under kubernetes/clusters/phobos/apps.
---
